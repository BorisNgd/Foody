...
<script>
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyCDTAQ7gBZAuowktfdCGFeeVJSpnupWQmI",
    authDomain: "myrestaurant-2ec7e.firebaseapp.com",
    databaseURL: "https://myrestaurant-2ec7e.firebaseio.com",
    projectId: "myrestaurant-2ec7e",
    storageBucket: "myrestaurant-2ec7e.appspot.com",
    messagingSenderId: "855024568126",
  ...
  export default {
    data() {
      return {
        ...
        f7params: {
          id: 'io.framework7.foody', // App bundle ID
          name: 'Foody', // App name
